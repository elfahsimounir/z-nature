              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col gap-4.5 mt-4.5">
                  ...
                  >
                    ...
                    >
                      <path
                        d="M16.365 13.365c-.27.63-.6 1.23-.99 1.8-.39.57-.84 1.11-1.365 1.62-.525.51-1.11.96-1.755 1.35-.645.39-1.335.585-2.07.585-.57 0-1.11-.075-1.62-.225-.51-.15-.99-.36-1.44-.63-.45-.27-.855-.6-1.215-.99-.36-.39-.675-.84-.945-1.35-.27-.51-.48-1.08-.63-1.71-.15-.63-.225-1.305-.225-2.025 0-.72.075-1.395.225-2.025.15-.63.36-1.2.63-1.71.27-.51.585-.96.945-1.35.36-.39.765-.72 1.215-.99.45-.27.93-.48 1.44-.63.51-.15 1.05-.225 1.62-.225.735 0 1.425.195 2.07.585.645.39 1.23.84 1.755 1.35.525.51.975 1.05 1.365 1.62.39.57.72 1.17.99 1.8-.72.27-1.38.63-1.98 1.08-.6.45-1.11.99-1.53 1.62-.42.63-.735 1.32-.945 2.07.57.15 1.11.225 1.62.225.735 0 1.425-.195 2.07-.585.645-.39 1.23-.84 1.755-1.35.525-.51.975-1.05 1.365-1.62.39-.57.72-1.17.99-1.8-.72-.27-1.38-.63-1.98-1.08-.6-.45-1.11-.99-1.53-1.62-.42-.63-.735-1.32-.945-2.07.57-.15 1.11-.225 1.62-.225.735 0 1.425.195 2.07.585.645.39 1.23.84 1.755 1.35.525.51.975 1.05 1.365 1.62.39.57.72 1.17.99 1.8z"
                        fill="#000"
                      />
                    </svg>
                    Sign In with Apple
