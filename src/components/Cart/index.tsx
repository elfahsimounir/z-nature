      ...
      {cartItems.length > 0 ? (
        <section className="overflow-hidden py-20 bg-gray-2">
          <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
            <div className="flex flex-wrap items-center justify-between gap-5 mb-7.5">
              ...
              }} className="text-primary">Clear Shopping Cart</button>
            </div>
        ...
        <>
          <div className="text-center mt-8">
            ...
            <p className="pb-6">Continuer les achats</p>

            <Link
              href="/shop"
              className="w-96 mx-auto flex justify-center font-medium text-primary bg-primary/10 py-[13px] px-6 rounded-md ease-out duration-200 hover:bg-primary/20"
            >
              Continue Shopping
            </Link>
          </div>
