  ...
  return (
    <div className="flex items-center border-t border-gray-3 py-5 px-7.5">
      <div className="min-w-[400px]">
        <div className="flex items-center justify-between gap-5">
          <div className="w-full flex items-center gap-5.5">
            <div className="flex items-center justify-center rounded-[5px] bg-gray-2 max-w-[50px] w-full h-14">
              <Image width={100} height={100} src={item.images[0]?.url} alt={item.name}/>
            </div>
      ...
      <div className="min-w-[180px]">
        <p className="text-dark">{item.price - item.discount} DH</p>
      </div>

      <div className="min-w-[275px] flex">
        <div className=" flex items-center rounded-md border gray-2 ">
          <Button variant={'ghost'} onClick={() => handleDecreaseQuantity()} aria-label="button for remove product">
          <svg
      ...
      <div className="min-w-[200px]">
        <p className="text-dark">{(item.price - item.discount) * quantity}DH</p>
      </div>
