        ...
        <div className="relative z-1 overflow-hidden rounded-xl">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 px-4 sm:px-7.5 xl:pl-12.5 xl:pr-14 py-11">
            <div className="max-w-[491px] w-full">
              <h2 className="max-w-[399px] text-white font-bold text-lg sm:text-xl xl:text-heading-6 mb-3">
            ...
            <div className="max-w-[477px] w-full">
              <form>
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <button
                    type="submit"
                    className="inline-flex justify-center py-3 px-7 text-primary bg-white/70 backdrop-blur-md font-medium rounded-md ease-out duration-200 hover:bg-white"
                  >
                    S&apos;abonner
                  </button>
                </div>
