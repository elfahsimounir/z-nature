  ...
  return (
    ...
    >
      <div className="flex items-center justify-end">
        <div className="w-full max-w-[500px] shadow-1 h-screen bg-white px-4 sm:px-7.5 lg:px-11 relative modal-content">
          ...
          <div className="border-t border-gray-3 bg-white pt-5 pb-4 sm:pb-7.5 lg:pb-11 mt-7.5 sticky bottom-0">
            <div className="flex items-center justify-between gap-5 mb-6">
              ...
              <p className="font-medium text-xl text-dark">{totalPrice}DH</p>
            </div>
            ...
            <div className="flex items-center gap-4">
              <Link
                onClick={() => closeCartModal()}
                href="/cart"
                className={` w-full text-center font-medium hover:bg-primary/30 text-primary py-3 px-7 rounded-md ease-out duration-200 bg-primary/10`}
              >
              Voir le panier
              </Link>
              ...
              <Link
                onClick={() => closeCartModal()}
                href="/checkout"
                className={` w-full text-center font-medium hover:bg-secondary/30 text-dark py-3 px-7 rounded-md ease-out duration-200 bg-dark/10
                  `}
              >
                Checkout
              </Link>
