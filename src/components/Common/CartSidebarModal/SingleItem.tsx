...
const SingleItem = ({ item, removeItemFromCart,onClick }) => {
  ...
  return (
    <div className="flex items-center justify-between gap-5">
      <div className="w-full flex items-center gap-6">
        ...
        <div>
          <div  className="font-medium text-dark mb-1 ease-out duration-200 ">
            <Link onClick={onClick} href={`shop/${formatSlug(item.slug?item.slug:'')}`}> {item.name} </Link>
          </div>
          <div className="text-sm">
          <p className="text-custom-sm">Price : {item.price - item.discount} DH</p>
