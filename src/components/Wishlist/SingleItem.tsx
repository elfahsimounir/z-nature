    ...
    <div className="flex items-center border-t border-gray-3 py-5 px-10">
      ...
      <div className="min-w-[150px] flex justify-end">
        <button
          ...
          className="inline-flex text-sm text-primary bg-gray-1 border border-gray-3 py-2.5 px-6 rounded-md ease-out duration-200 hover:bg-primary/10 bg-primary/5  "
        >
          Add to Cart
        </button>
      </div>
