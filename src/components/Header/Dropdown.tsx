      ...
      >
        {menuItem.submenu.map((item, i) => (
          <li key={i}>
            <Link
              href={item.path}
              className={`flex text-custom-sm hover:text-primary hover:bg-primary/5 py-[7px] px-4.5 ${
                pathUrl === item.path && "text-primary bg-primary/5"
              } `}
            >
              {item.title}
            </Link>
